...
<br><br>
<!-- <p>Please click here to approve leave <a href="{{{ URL::to('employeeleaveapplication/approve/'.$application->id.'/'.$application->applied_start_date.'/'.$application->applied_end_date) }}}">Approve Leave</a>&emsp|&emsp<a href="{{{ URL::to('employeeleaveapplication/approve/'.$application->id.'/'.$application->applied_start_date.'/'.$application->applied_end_date) }}}">Reject Leave</a></p>
 -->
 <p>Please click here to approve leave <a href="{{{ URL::to('supervisor/approve/'.$application->id) }}}">Approve Leave</a>&emsp;|&emsp;<a href="{{{ URL::to('supervisor/reject/'.$application->id) }}}">Reject Leave</a></p>
