...
class TenantsTableSeeder extends Seeder {
	...
	public function run()
	{
        ...
        DB::table('job_group')->insert(array(
            array('job_group_name' => 'HOD','organization_id' => '1','created_at' => date('Y-m-d H:i:s'),'updated_at' => date('Y-m-d H:i:s')),
            array('job_group_name' => 'HR','organization_id' => '1','created_at' => date('Y-m-d H:i:s'),'updated_at' => date('Y-m-d H:i:s')),
