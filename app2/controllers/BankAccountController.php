...
class BankAccountController extends \BaseController {
	...
	public function store()
	{
		...
		$bnkAccount->organization_id = Confide::user()->organization_id;
			...
			if(Input::hasFile('bknStatementCSV')){
					...
					if($csv_file->isValid()){
				      ...
				      // INSERT BANK STATEMENT DATA TO DB
					  	...
					  	$bnk_statement->organization_id = Confide::user()->organization_id;
    ...
    */
	...
	public function reconcileStatement(){
		if(Input::get('btnReconcile')){
			...
			//$acTransaction->organization_id = Confide::user()->organization_id;
			...
			//$stmtTransaction->organization_id = Confide::user()->organization_id;
	...
	public function saveStatementTransaction(){
		...
		$aTransaction->organization_id = Confide::user()->organization_id;
