...
class SavingproductsController extends \BaseController {
	...
	public function create()
	{
		...
		$currencies = Currency::where('organization_id',Confide::user()->organization_id)->get();
	...
	*/
	public function selectproduct($id){
		$product=Savingproduct::where('id','=',$id)
	...
	public function destroy($id)
	{
		...
		//->select('id')->get();
		Savingposting::where('savingproduct_id','=',$id)->where('organization_id',Confide::user()->organization_id)->delete();
		Savingaccount::where('savingproduct_id','=',$id)->where('organization_id',Confide::user()->organization_id)->delete();
