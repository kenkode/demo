...
<img src="{{asset('/public/uploads/photos/'.$employee->photo) }}" width="150px" height="130px" alt="">

<br>
<br>

<img src="{{asset('/public/uploads/photos/'.$employee->signature) }}" width="150px" height="130px" alt="">
...
<tr><td colspan="2"><strong><span style="color:green">Personal Information</span></strong></td></tr>
     ...
     <tr><td><strong>Gender:</strong></td>
        ...
        <tr><td><strong>Sacco Member:</strong></td>
        @if($employee->member_id != null)
        <td>Yes</td>
        @else
        <td>No</td>
        @endif
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                   <li><a href='{{asset("public/uploads/documents/".$document->document_path)}}'>Download</a></li>
