...
function dcheck(){
  ...
  $('#'+id).html(key+1);
   ...
   <div class="checkbox">
          <label>
             <input type="checkbox" value="{{{ $employee->member_id }}}" id="is_member" name="is_member"<?= ($employee->member_id != null || $employee->member_id != 0)?'checked="checked"':''; ?>>
                              Activate As Member
          </label>
    </div>
</div>
