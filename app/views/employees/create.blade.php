  ...
  <br><br>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="" type="text" name="personal_file_number" id="personal_file_number" value="{{'E'.initials($organization->name,$pfn)}}" >
                    </div>
...
<div class="col-lg-6">
   <div class="checkbox">
          <label>
             <input type="checkbox" value="1" id="is_member" name="is_member">
                              Activate As Member
          </label>
    </div>
    ...
    <div id="mem">
       <div class="form-group">
          <label for="username">Monthly Remittance</label>
             <input class="form-control" placeholder="" type="text" name="monthly_remittance_amount" id="monthly_remittance" >
       </div>
