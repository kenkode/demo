...
<div id="dialog-form" title="Create new employee type">
  ...
  @if ($errors->has())
    ...
    <li role="presentation"><a href="#member" aria-controls="member" role="tab" data-toggle="tab">Member</a></li>
    </ul>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div id="imagePreview" style="background-image:url({{asset('/public/uploads/photos/'.$employee->photo) }})"></div>
                        
                        <input class="img" placeholder="" type="file" name="image" id="uploadFile" value="{{{ $employee->photo }}}">
                    </div>

                    <div class="form-group">
                        <label for="username">Signature</label><br>
                        
                        <div id="signPreview" style="background-image:url({{asset('/public/uploads/photos/'.$employee->signature) }})"></div>
...
<div class="col-lg-6">
   <div class="checkbox">
          <label>
             <input type="checkbox" value="1" id="is_member" name="is_member"<?= ($employee->member_id != null || $employee->member_id != 0)?'checked="checked"':''; ?>>
                              Activate As Member
          </label>
    </div>
    ...
    <div id="mem">
       <div class="form-group">
          <label for="username">Monthly Remittance</label>
             <input class="form-control" placeholder="" type="text" name="monthly_remittance_amount" id="monthly_remittance" value="{{{ Member::getMember($employee->member_id) }}}">
       </div>

       <div class="form-group">
                        <label for="username">Member Group (Optional)</label>
                         <select name="group_id" class="form-control">
                            <option></option>
                            @foreach($groups as $group)
                            <option value="{{$group->id }}"<?= (Member::getGroup($employee->member_id)==$group->id && Member::getGroup($employee->member_id) != '')?'selected="selected"':''; ?>> {{ $group->name }}</option>
                            @endforeach
