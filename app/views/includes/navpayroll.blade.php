    ...
    <div id="wrapper">
		...
		<?php $organization = Organization::find(Confide::user()->organization_id); ?>
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            <a  href="{{ URL::to('hrdashboard')}}">
                                <i class="glyphicon glyphicon-credit-card fa-fw"></i>  {{{ Lang::get('messages.nav.hr') }}}
                            </a>
                        </li>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-users fa-fw"></i> {{{ Lang::get('messages.nav.employees') }}} <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            <a href="{{ URL::to('employeeportal')}}">
                                <i class="fa fa-user fa-fw"></i>  {{{ Lang::get('messages.nav.emp_css') }}} 
                            </a>
                        </li>
