...
#ncontainer table{border-collapse:collapse;border-radius:25px;width:600px;}
            ...
            <div class="col-lg-4">
                 ...
                 <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="" readonly type="text" name="membership_no" id="membership_no" value="{{$member->membership_no}}" >
                    </div>
            ...
            <div class="col-lg-12">
                 ...
                 <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="" type="text" name="pin" id="pin" value="{{$member->employee->pin}}">
                    </div>

                     <div class="form-group">
                        <label for="username">Nssf Number</label>
                        <input class="form-control" placeholder="" type="text" name="social_security_number" id="social_security_number" value="{{$member->employee->social_security_number}}">
                    </div>

                    <div class="form-group">
                        <label for="username">Nhif Number</label>
                        <input class="form-control" placeholder="" type="text" name="hospital_insurance_number" id="hospital_insurance_number" value="{{$member->employee->hospital_insurance_number}}">
                    </div>
                    </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" checked name="i_tax" id="itax"<?= ($member->employee->income_tax_applicable=='1')?'checked="checked"':''; ?>>
                              Apply Income Tax
                        </label>
                    </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" checked name="i_tax_relief" id="irel"<?= ($member->employee->income_tax_relief_applicable=='1')?'checked="checked"':''; ?>>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" checked name="a_nssf" id="a_nssf"<?= ($member->employee->social_security_applicable=='1')?'checked="checked"':''; ?>>
                               Apply Nssf
                        </label>
                    </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" checked name="a_nhif" id="a_nhif"<?= ($member->employee->hospital_insurance_applicable=='1')?'checked="checked"':''; ?>>
                                Apply Nhif
                        </label>
                    </div>
                    </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" readonly placeholder="" type="text" name="pay" id="pay" value="{{ $member->employee->basic_pay*100 }}">
                       </div>
                       <script type="text/javascript">
                       $(document).ready(function() {
                       $('#pay').priceFormat();
...
<div class="row">
             ...
             <div class="col-lg-4">
                 ...
                 <fieldset>
                    <div class="form-group">
                        <label for="username">Member First Name</label>
                        <input class="form-control" placeholder="" type="text" name="fname" id="fname" value="{{$member->first_name}}" required>
                    </div>

                    <div class="form-group">
                        <label for="username">Member Last Names</label>
                        <input class="form-control" placeholder="" type="text" name="lname" id="lname" value="{{$member->last_name}}" required>
                    </div>

                    <div class="form-group">
                        <label for="username">Member Other Names</label>
                        <input class="form-control" placeholder="" type="text" name="mname" id="mname" value="{{$member->middle_name}}" required>
                    </div>
             ...
             <div class="col-lg-4">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" readonly placeholder="" type="text" name="monthly_remittance_amount" id="monthly_remittance_amount" value="{{ $member->monthly_remittance_amount }}">
                    </div>
