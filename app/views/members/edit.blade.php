		 ...
		 <form method="POST" action="{{{ URL::to('members/update/'.$member->id) }}}" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="col-lg-12">
                 ...
                 <fieldset>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="1" id="is_employee" name="is_employee"<?= ($member->is_employee=='1')?'checked="checked"':''; ?>>
                                Employee
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="" type="text" name="pay" id="pay" value="{{ $member->employee->basic_pay*100 }}">
                       </div>
                       <script type="text/javascript">
                       $(document).ready(function() {
                       $('#pay').priceFormat();
...
<table id="nextkin" border="1" cellspacing="0">
  ...
  <tr>
    ...
    <td><input class="kindata" type='text' id='goodwill' name='goodwill[0]' value="{{$kin->goodwill}}"/></td>
