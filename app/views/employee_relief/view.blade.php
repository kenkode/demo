...
<img src="{{asset('/public/uploads/photos/'.$rel->photo) }}" width="150px" height="130px" alt=""><br>
<br>
<img src="{{asset('/public/uploads/photos/'.$rel->signature) }}" width="120px" height="50px" alt="">
</div>
