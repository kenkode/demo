...
<img src="{{asset('/public/uploads/photos/'.$overtime->employee->photo) }}" width="150px" height="130px" alt=""><br>
<br>
<img src="{{asset('/public/uploads/photos/'.$overtime->employee->signature) }}" width="120px" height="50px" alt="">
</div>
