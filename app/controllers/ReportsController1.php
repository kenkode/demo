...
class ReportsController extends \BaseController {
  ...
  Excel::create('Payslips', function($excel) use($data,$nontaxables,$name,$period,$employee,$allws,$earnings,$overtimes,$rels,$deds,$organization,$currency,$loans) {
  ...
  Excel::create($save.'_'.$month.' Payslip', function($excel) use($data,$nontaxables,$name,$period,$employee,$allws,$earnings,$overtimes,$rels,$deds,$organization,$loans,$currency) {
   ...
   $objPHPExcel->setActiveSheetIndex(0); 
    ...
    $pdf = PDF::loadView('pdf.monthlySlip', compact('nontaxables','empall','select','name','employee','transact','allws','deds','earnings','overtimes','loans','rels','period','currency', 'organization','id'))->setPaper('a5')->setOrientation('potrait');
