...
public static $rules = [
    ...
    public static function loans($member_id,$loanaccount,$period){

                $loan = 0.00;
                if($member_id == null || $member_id == 0){
                $loan = 0.00;
                }else{
                if($loanaccount->loan_status == 'open'){
                ...
                $total_principal = $total_principal + $principal_amount;
                  ...
                  if($loanaccount->loanproduct->formula == 'RB'){
                    $interest_amount =$balance* ($loanaccount->interest_rate/100);
                  }
    ...
    public static function totalloans($loanproduct){


                $loanaccounts = Loanaccount::where('is_approved',1)
                              ->where('loanproduct_id',$loanproduct)
    ...
    public static function totalmemberloans($memberid){
    ...
    public static function remittances($member_id){
                ...
                $amount = 0.00;
                 ...
                 $amount = $member->monthly_remittance_amount;
    ...
    public static function savings($member_id,$loanaccount,$period){
    ...
    public static function totalallowances($allowance_id,$period){
    ...
    $allw = DB::table('employee_allowances')
                     ...
                     ->where(function ($query) use ($allowance_id,$start){
                      ...
                      ->orWhere(function ($query) use ($allowance_id,$start) {
                        $query->where('allowance_id', '=', $allowance_id)
                              ->where('instalments', '>', 0)
                              ->where('first_day_month','<=',$start)
                              ->where('last_day_month','>=',$start);
    ...
    public static function totalnontaxable($nontaxable_id,$period){
    ...
    $nontaxable = DB::table('employeenontaxables')
                     ...
                     ->where(function ($query) use ($nontaxable_id,$start){
                      ...
                      ->orWhere(function ($query) use ($nontaxable_id,$start) {
                        $query->where('nontaxable_id', '=', $nontaxable_id)
                              ->where('instalments', '>', 0)
                              ->where('first_day_month','<=',$start)
                              ->where('last_day_month','>=',$start);
    ...
    public static function totalearnings($earning_id,$period){
   ...
   $earn = 0.00;
    ...
    $total_earns = DB::table('earnings')
                     ...
                     ->where(function ($query) use ($earning_id,$start){
                      ...
                      ->orWhere(function ($query) use ($earning_id,$start) {
                        $query->where('earning_id', '=', $earning_id)
                              ->where('instalments', '>', 0)
                              ->where('first_day_month','<=',$start)
                              ->where('last_day_month','>=',$start);
   ...
   public static function total_pay(){
    $salary = DB::table('employee')->where('organization_id',Confide::user()->organization_id)->sum('basic_pay');
   ...
   public static function overtimes($id,$overtime,$period){
    ...
    public static function totalovertimes($overtime,$period){
    ...
    $otime = DB::table('overtimes')
                     ...
                     ->where(function ($query) use ($overtime,$start){
                      ...
                      ->orWhere(function ($query) use ($overtime,$start) {
                        $query->where('type', '=', $overtime)
                              ->where('instalments', '>', 0)
                              ->where('first_day_month','<=',$start)
                              ->where('last_day_month','>=',$start);
   ...
   public static function totaldeductions($deduction_id,$period){
   ...
   $deds = DB::table('employee_deductions')
                     ...
                     ->where(function ($query) use ($deduction_id,$start){
                      ...
                      ->orWhere(function ($query) use ($deduction_id,$start) {
                        $query->where('deduction_id', '=', $deduction_id)
                              ->where('instalments', '>', 0)
                              ->where('first_day_month','<=',$start)
                              ->where('last_day_month','>=',$start);
   ...
   public static function total_deductions($id,$period){
    ...
    public static function processedremittances($id,$period){

    $remittance = 0.00;
    
    $pays = DB::table('transact_loans')
                     ->select('employee_id',DB::raw('COALESCE(sum(monthly_remittance),0.00) as remittance'))
                     ->where('organization_id',Confide::user()->organization_id)
                     ->where('financial_month_year' ,'=', $period)
                     ->where('employee_id', '=', $id)
                     ->groupBy('employee_id')
    ...
    foreach($pays as $pay){
    $salary = $pay->remittance;
    }
    
    return  number_format($remittance,2);
   ...
   public static function processedovertimes($id,$period){
    ...
    public static function processedloanproductnames($id,$period){

    $loanproduct = '';
    
    $total_loans= DB::table('transact_loans')
                     ->select('employee_id','loanproduct_name')
                     ->where('organization_id',Confide::user()->organization_id)
                     ->where('financial_month_year' ,'=', $period)
                     ->where('employee_id', '=', $id)
    ...
    foreach($total_loans as $total_loan){
    $loanproduct = $total_loan->loanproduct_name;
    }
    ...
    public static function processedLoans($id,$period){

    $loans = 0.00;
    
    $total_loans= DB::table('transact_loans')
                     ->select('employee_id',DB::raw('COALESCE(sum(amount),0.00) as total_loans'))
                     ->where('organization_id',Confide::user()->organization_id)
                     ->where('financial_month_year' ,'=', $period)
                     ->where('employee_id', '=', $id)
                    ->groupBy('deduction_name')
    ...
    foreach($total_loans as $total_loan){
    $loans = $total_loan->total_loans;
    }
    
    return  number_format($loans,2);
   ...
   public static function nhifncalc($net){
    ...
    public static function transactloans($id,$name,$period){
    ...
    $total_loans = DB::table('transact_loans')
                  ...
                  ->where('financial_month_year' ,'=', $period)
                  ->where('personal_file_number' ,'=', $id)
                  ->where('loanproduct_name' ,'=', $name)
                  ->select(DB::raw('COALESCE(sum(amount),0.00) as amount'))
                  ->get();
                      
    foreach($total_loans as $total_loan){
    $loan = $total_loan->amount;
    }
  ...
  public static function totaltransactreliefs($name,$branch,$dept,$period){
   ...
   $deduction = 0.00;
    ...
    public static function totaltransactloans($name,$branch,$dept,$period){
 
   $deduction = 0.00;

    if($branch == 'All' && $dept == 'All'){
    $total_deductions = DB::table('transact_loans')
                     ->join('employee', 'transact_loans.employee_id', '=', 'employee.id')
                     ->select(DB::raw('COALESCE(sum(amount),0.00) as amount'))
                     ->where('financial_month_year' ,'=', $period)
                     ->where('employee.organization_id',Confide::user()->organization_id)
    ...
    foreach($total_deductions as $total_deduction){
    $deduction = $total_deduction->amount;
    }
